...
class GitHubPullRequestConfig(BaseModel):
    ...
    filter: Optional[GitHubPullRequestFilterConfig] = Field(
        default=None,
        description="Filter configuration for pull requests, e.g., tokens to ignore.",
    )
    update_description_from_pr_body: Optional[bool] = Field(
        default=None,
        description="If true, updates the current build description with the body of the pull request.",
    )
